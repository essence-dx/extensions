...
try {
    $proofPath = Join-Path (Resolve-Path ".").Path ".tmp\proofs\office-google-release-package-checksums.json"
    ...
    $env:DX_VERIFICATION_COMMAND = "npm run package:office-google-release-checksum:j1"
